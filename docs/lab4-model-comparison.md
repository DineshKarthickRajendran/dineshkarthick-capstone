...
------------------------------------------------------------
gpt-4o-mini             10    0.000839    0.000084    20.72s
gpt-4o                  10    0.015688    0.001569    24.72s
```
...
The models reported nearly identical average confidence (`0.91` for `gpt-4o` versus `0.905` for `gpt-4o-mini`), suggesting they had a similar view of what they knew despite `gpt-4o` costing much more.
